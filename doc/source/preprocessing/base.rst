...
.. automodule:: pyitab.preprocessing.base
   :members:
   :undoc-members:
...
* :doc:`functions` : 
* :doc:`mapper` : list of all :class:`~pyitab.preprocessing.base.Transformer` s 
...
* :doc:`pipelines` : used to concatenate different :class:`~pyitab.preprocessing.base.Transformer` s
